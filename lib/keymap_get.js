...
async function getKeymap(options) {
  ...
  try {
    ...
    // Defaulting to the first device as per current standard for these CLI tools
    // TODO: Implement board selection if multiple devices (via options.board or similar)
